...
echo
echo "4. AVAILABLE DIAGNOSIS CODES"
...
echo
echo "5. CHART DIAGNOSIS HISTORY"
echo "   - The installer fills in the patient problem list with diagnosis codes"
echo "   - The Primary Diagnosis field should no longer be blank"
echo "   - The history popup will have real codes to select"
echo
echo "6. OPEN JOHN DOE'S CHART"
echo "   - Click 'Patients'"
echo "   - Open John Doe's chart"
echo "   - Stay inside the patient chart / Encounter area"
echo
echo "7. CREATE A LAB ORDER"
